...
public class Administrativo extends Usuario implements Asesoria {
    ...
    public Administrativo(String nombre, String apellido, int rut, String email, LocalDate fechaNacimiento, String area, String experienciaPrevia) {
        super(nombre, apellido, rut, email, fechaNacimiento);
        this.area = area;
